                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr>
                                            ...
                                            {question.subquestions.map((subquestion, subquestionIndex) => (
                                                <th key={subquestionIndex} className="px-4 py-2 bg-gray-700">
                                                    {subquestion.content}
                                    ...
                                    <tbody>
                                        {question.answers.map((answer, answerIndex) => (
                                            <tr key={answerIndex}>
                                                <td className="px-4 py-2 bg-gray-700">{answer.content}</td>
                                                {question.subquestions.map((_, subquestionIndex) => (
                                                    <td key={subquestionIndex} className="px-4 py-2 bg-gray-700">
                                                        <input
                                                            type="checkbox"
